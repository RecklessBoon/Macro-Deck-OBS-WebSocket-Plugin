...
namespace SuchByte.OBSWebSocketPlugin.Language
{
    public class PluginStrings
    {
        ...
        public string ActionSetRecordingStateDescription = "Start/stop/toggle recording";
        public string ActionSetStreamingState = "Set OBS streaming state";
        public string ActionSetStreamingStateDescription = "Start/stop/toggle streaming";
        public string ActionSetVirtualCamState = "Set OBS virtual cam state";
        public string ActionSetVirtualCamStateDescription = "Start/stop/toggle virtual cam";
        ...
        public string GeneralBy = "by";
        public string GeneralTo = "to";
